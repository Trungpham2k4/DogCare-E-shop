<!DOCTYPE html>
   ...
   <head>
      ...
      <!--=============== CSS ===============-->
      <link rel="stylesheet" href="../views/css/login.css?v=<?php echo time();?>">
   ...
   <body>
      ...
      <svg class="login__blob" viewBox="0 0 566 840" xmlns="http://www.w3.org/2000/svg">
         ...
         <g mask="url(#mask0)">
            ...
            <image class="login__img" href="../views/images/img/beautiful-dog-pictures-1080-x-1920-oknrc7wqphoq8bkx copy.jpg"/>
         </g>
      </svg>      
               ...
               <div class="login__social">
                  ...
                  <div class="login__social-links">
                     <a href="#" class="login__social-link">
                        <img src="../views/images/img/icon-google.svg" alt="image" class="login__social-img">
                     </a>
      
                     <a href="#" class="login__social-link">
                        <img src="../views/images/img/icon-facebook.svg" alt="image" class="login__social-img">
                     </a>
                  </div>
               </div>
         ...
         <div class="login__register">
            ...
            <div class="login__area">
               <form id="registerForm" class="login__form">
                  ...
                  <!-- Nút bấm để submit thông tin đăng ký -->
      ...
      <!--=============== MAIN JS ===============-->
      <script src="../views/js/login.js?v=<?php echo time();?>"></script>
   </body>
</html>