...
<section class="listItem">
    <h2 class="listItemCaption" id="cap">Item List</h2>

    <div class="foodItemNavigation">
        <div class="FoodNavItem">
            <a href="../controllers/admin.php?page=home" class="FoodNavLinkItem">Food</a>
        </div>
        <div class="ItemNavItem">
            <a href="../controllers/admin.php?page=item" class="ItemNavLinkItem">Item</a>
        </div>
    </div>
